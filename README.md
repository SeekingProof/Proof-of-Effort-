# Proof-of-Effort-
Evidence of genuine human effort in writing produced in the age of AI — non-biometric, content-free, portable attestation of the composition process.
# Proof of Effort (PoE)
...
PoE provides evidence that a document was genuinely composed by a person, in an
era where AI writing makes that hard to establish. It runs as an extension in
popular word processors such as **LibreOffice** and **Microsoft Word**, with
coding software solutions in development. While you write, PoE records
content-free metadata about the composition process — the pauses, revisions, and
reconsideration that accompany genuine writing. That evidence is stored as
metadata **within the document itself**, and can optionally be sealed into a
portable artifact.

If you have been asked to show that a person — not a generative tool — did the
work of writing something, PoE produces that evidence: a record of the effort
behind the document, grounded in decades of peer-reviewed writing-process
research.

## What PoE is — and is not

PoE **is** a measurement tool. It measures characteristics of the composition
...
- **Not an AI detector.** It does not analyze finished text for signatures of
  machine generation and issues no verdict about whether content was
  AI-generated.
- **Not an authorship or identity check.** It attests that genuine human
  composition effort occurred; it does not determine who wrote a document.
- **Not a plagiarism tool.** It does not compare text against external sources.
- **Not biometric.** It builds no template capable of identifying an individual.

PoE measures the *process* of writing rather than judging the *product* — which
is why improving AI writing quality does not erode the evidence.
